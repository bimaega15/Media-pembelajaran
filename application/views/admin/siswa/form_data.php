                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="<?= base_url('Admin/Siswa/process') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_induk" class="form-control  <?= form_error('nomor_induk') != null ? 'border border-danger' : '' ?>" placeholder="Nomor induk" value="<?= $row->nomor_induk != null ? $row->nomor_induk : set_value('nomor_induk') ?>">
                                    <?= form_error('nomor_induk') ?>
                                </div>
                                <div class="form-group">
                                    <label for="gambar_profile">Foto Profile</label><br>
                                    <?php
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <select name="jurusan_id" class="form-control <?= form_error('jurusan_id') != null ? 'border border-danger' : '' ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" class="form-control  <?= form_error('email') != null ? 'border border-danger' : '' ?>" placeholder="Email" value="<?= $row->email != null ? $row->email : set_value('email') ?>">
                                            <?= form_error('email') ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sekolah_asal" name="sekolah_asal" class="form-control  <?= form_error('sekolah_asal') != null ? 'border border-danger' : '' ?>" placeholder="Sekolah Asal" value="<?= $row->sekolah_asal != null ? $row->sekolah_asal : set_value('sekolah_asal') ?>">
                                            <?= form_error('sekolah_asal') ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="akta_siswa">Akta Kelahiran</label>
                                            <?php
                                            if ($row->akta != null) { ?>
                                                <a href="<?= base_url('image/akta/' . $row->akta) ?>" target="_blank">Akta</a>
                                            <?php
                                            }
                                            ?><br>
                                            <input type="file" accept="application/pdf" name="akta_siswa" class="form-control">
                                        </div>
                                        <div class="form_group">
                                            <label for="ijazah_siswa">Ijazah Terbaru</label>
                                            <?php
                                            if ($row->ijazah != null) { ?>
                                                <a href="<?= base_url('image/ijazah/' . $row->ijazah) ?>" target="_blank">Ijazah</a>
                                            <?php
                                            }
                                            ?><br>
                                            <input type="file" name="ijazah_siswa" accept="application/pdf" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_ayah" class="form-control  <?= form_error('nama_ayah') != null ? 'border border-danger' : '' ?>" placeholder="Nama ayah" value="<?= $row->nama_ayah != null ? $row->nama_ayah : set_value('nama_ayah') ?>">
                                            <?= form_error('nama_ayah') ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="">No. HP Ayah</label>
                                            <input type="text" name="no_hp_ayah" class="form-control  <?= form_error('no_hp_ayah') != null ? 'border border-danger' : '' ?>" placeholder="Nomor HP ayah" value="<?= $row->no_hp_ayah != null ? $row->no_hp_ayah : set_value('no_hp_ayah') ?>">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_ibu" class="form-control  <?= form_error('nama_ibu') != null ? 'border border-danger' : '' ?>" placeholder="Nama ibu" value="<?= $row->nama_ibu != null ? $row->nama_ibu : set_value('nama_ibu') ?>">
                                            <?= form_error('nama_ibu') ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="">No. HP ibu</label>
                                            <input type="text" name="no_hp_ibu" class="form-control  <?= form_error('no_hp_ibu') != null ? 'border border-danger' : '' ?>" placeholder="Nomor HP ibu" value="<?= $row->no_hp_ibu != null ? $row->no_hp_ibu : set_value('no_hp_ibu') ?>">
